...
public class ChatBot {
    ...
    public static String process(String message) {
        ...
        if (professionSalary < 0) {
            return "I couldn't find a name of the profession in your message.";
        }

        if (dreamCost < 0) {
            return "I couldn't find a name of the dream in your message.";
        }

        int monthCount = calculateMonthCount(dreamCost, professionSalary);

        return "In order your dream come true you need: " + monthCount;
    }
    ...
    private static boolean isHelloMessage(String message) {
        ...
        return message.contains(helloWord1);
    }
}
